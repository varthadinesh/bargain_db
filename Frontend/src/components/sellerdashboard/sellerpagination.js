...
const Sellerpagination = (props) => {
  const { stateData, setViewRowIndex, pageSize,setPageSize, currentPage, setCurrentPage } = props;
...
// eslint-disable-next-line no-unused-vars
  ...
  return (
    <div className="d-md-flex text-center justify-content-center w-100 bg-secondary text-white mb-3  mt-3">
      <nav className='mt-2'>
        {generatePageNumbers()}
      </nav>
    </div>
