        ...
        <div className="card-body">
            ...
            <div className="d-flex flex-wrap align-items-start">
              {materials.map((material) => (
                <button
                  ...
                  style={{
                    border:
                      selectedMaterial === material ? "1px solid black" : "",
                    backgroundColor:
                      selectedMaterial === material ? "lightGrey" : "",
                  }}
          ...
          <div className="mt-4">
            ...
            <div className="d-flex  flex-wrap align-items-start">
              <button
                className={`btn border m-1 ${
                  selectedPriceRange === "below500" ? "active" : ""
                }`}
                style={{
                  border:
                    selectedPriceRange === "below500" ? "1px solid black" : "",
                  backgroundColor:
                    selectedPriceRange === "below500" ? "lightGrey" : "",
                }}
              ...
              <button
                className={`btn border m-1 ${
                  selectedPriceRange === "500to1000" ? "active" : ""
                }`}
                style={{
                  border:
                    selectedPriceRange === "500to1000" ? "1px solid black" : "",
                  backgroundColor:
                    selectedPriceRange === "500to1000" ? "lightGrey" : "",
                }}
              ...
              <button
                className={`btn border m-1 ${
                  selectedPriceRange === "1000to2000" ? "active" : ""
                }`}
                style={{
                  border:
                    selectedPriceRange === "1000to2000"
                      ...
                      : "",
                  backgroundColor:
                    selectedPriceRange === "1000to2000" ? "lightGrey" : "",
                }}
              ...
              <button
                className={`btn border m-1 ${
                  selectedPriceRange === "above2000" ? "active" : ""
                }`}
                style={{
                  border:
                    selectedPriceRange === "above2000" ? "1px solid black" : "",
                  backgroundColor:
                    selectedPriceRange === "above2000" ? "lightGrey" : "",
                }}
            ...
            <div className="d-flex flex-row flex-wrap align-items-start">
              {colors.map((color) => (
                <div className="d-flex flex-column text-center position-relative">
                    ...
                    style={{
                      ...
                      border:
                        selectedColor === color.name
                          ...
                          : "1px solid black",
                      borderColor:
                        selectedColor === color.name ? "black" : "grey",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    {selectedColor === color.name && (
                      <i className="bi bi-check-lg fs-4 ms-4 mt-5 position-absolute translate-middle"></i>
                    )}
                  </button>
                </div>
              ))}
